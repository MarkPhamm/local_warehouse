...
<style>
    ...
    /* --- 5. INSIGHT CARDS (Replacing Expanders) --- */
    /* This simulates a clickable card look */
    .insight-card {
        ...
        cursor: default; /* Change to pointer if you make them buttons */
        position: relative;
        overflow: hidden;
    }
...
# Hidden anchors if you are using links elsewhere
